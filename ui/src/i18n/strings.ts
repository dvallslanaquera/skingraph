...
export const STRINGS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "scan.followup.thinking": "Thinking…",
    "scan.safety": "Safety",
    ...
    "scan.ingredients.showAll": "Show all {count}",
    "scan.ingredients.showLess": "Show fewer",
  ...
  ja: {
    ...
    "scan.ingredients.showAll": "全{count}件を表示",
    "scan.ingredients.showLess": "表示を減らす",
