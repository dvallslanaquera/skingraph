...
export const STRINGS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "profile.pregnancy": "🤰 Flag pregnancy-unsafe ingredients (e.g. retinoids)",
    ...
    "profile.budget.amortized": "For products that last more than a month, the coach compares your budget against the amortized cost. The price divided by the number of months the product is expected to last.",
    ...
    "routine.orderNote": "Products are listed in the order you apply them, morning and night. When a step needs to absorb before the next, a wait is shown.",
    "routine.wait": "Wait ~1 min before the next step",
    "routine.monthlyCost": "Average monthly cost",
    ...
    "check.ready.title": "Photo ready",
    "check.ready.hint": "Scan it to read the label and get your recommendation.",
  ...
  ja: {
    ...
    "profile.pregnancy": "🤰 妊娠中に注意が必要な成分（レチノイドなど）を警告する",
    ...
    "profile.budget.amortized": "1か月以上使える製品については、コーチは価格を使用可能な想定月数で割った「1か月あたりの費用」で予算と比較します。",
    ...
    "routine.remove": "削除",
    "routine.orderNote": "製品は、朝と夜それぞれ塗る順番で並んでいます。次のステップの前になじませる必要がある場合は、待ち時間が表示されます。",
    "routine.wait": "次のステップまで約1分待つ",
    "routine.monthlyCost": "平均月額コスト",
    ...
    "check.ready.title": "写真の準備ができました",
    "check.ready.hint": "スキャンしてラベルを読み取り、おすすめを受け取りましょう。",
