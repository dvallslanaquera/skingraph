...
export const STRINGS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "profile.sub": "This data personalises every scan's safety check and coaching.",
    ...
    "gender.other": "Non-binary / Prefer not to say",
  ...
  ja: {
    ...
    "profile.sub": "このデータが、すべてのスキャンの安全チェックとアドバイスをパーソナライズします。",
