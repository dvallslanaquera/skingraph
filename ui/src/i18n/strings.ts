...
export const STRINGS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "profile.sub": "This data personalises every scan's safety check and coaching — it's used only to tailor your advice, never sold or shared.",
    ...
    "profile.gender.help": "Skin thickness, oil and hormones differ between sexes, so this shapes what suits you — not for marketing.",
    "gender.male": "Male",
  ...
  ja: {
    ...
    "profile.sub": "このデータは、すべてのスキャンの安全チェックとアドバイスをあなた仕様にするためだけに使い、販売や共有は一切しません。",
    ...
    "profile.gender": "性別",
    "profile.gender.help": "性別により肌の厚み・皮脂・ホルモンが異なるため。マーケティング目的ではありません。",
    "gender.male": "男性",
    "gender.female": "女性",
    "gender.other": "回答しない",
